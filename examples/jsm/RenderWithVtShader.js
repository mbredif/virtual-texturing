export const RenderWithVtShader = {
  ...
  fragmentShader: [
    ...
    "{",
      ...
      "  case 0 : gl_FragColor = fract(vt_textureCoordsGrad(vt, uv, gx, gy)); break;",
      "  case 1 : gl_FragColor = fract(vt_textureCoordsLod (vt, uv, lod)); break;",
      "  case 2 : gl_FragColor = fract(vt_textureCoords    (vt, uv)); break;",
      "}",
    "}"
